...
const WIDTH_MM = 80; // thermal-receipt width
const MARGIN = 5;
...
y += 4;
  ...
  doc.setFont("helvetica", "normal");
  doc.setFontSize(8);
  doc.text("Thank you for your business!", WIDTH_MM / 2, y, {
    align: "center",
  });
  y += 4;
  doc.setFontSize(7);
  doc.setTextColor(110);
  doc.text("Goods sold are not returnable.", WIDTH_MM / 2, y, {
    align: "center",
  });
  y += 3.5;
  doc.text("Keep this receipt for your records.", WIDTH_MM / 2, y, {
    align: "center",
  });
